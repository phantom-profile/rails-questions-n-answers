...
ActiveRecord::Schema.define(version: 2021_09_23_181256) do
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.index ["user_id", "subscriptable_id"], name: "index_subscriptions_on_user_id_and_subscriptable_id", unique: true
